...
// num2 but not num1?
// The difference between num1 and num2 is that num1 is exclusive on both sides of its range,
//while num2 is inclusive. 1 and 10 would be valid for num2 but not num1.
